...
INSERT INTO parameters (variation_id, name, type, required, description) VALUES
(1, 'username', 'string', 1, 'User username'),
(1, 'password', 'string', 1, 'User password'),
(2, 'username', 'string', 1, 'User username'),
(2, 'password', 'string', 1, 'User password'),
(2, 'email', 'string', 0, 'Optional email');
